...
"""autogenerated by genpy from moveit_tutorials/ValidJointsActionResult.msg. Do not edit."""
import codecs
import sys
...
class ValidJointsActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "moveit_tutorials/ValidJointsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','moveit_tutorials/ValidJointsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ValidJointsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = moveit_tutorials.msg.ValidJointsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = moveit_tutorials.msg.ValidJointsResult()
