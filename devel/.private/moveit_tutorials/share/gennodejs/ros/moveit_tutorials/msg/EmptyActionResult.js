...
class EmptyActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = EmptyResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EmptyActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = EmptyResult.Resolve(msg.result)
    }
    else {
      resolved.result = new EmptyResult()
    }
...
module.exports = EmptyActionResult;
