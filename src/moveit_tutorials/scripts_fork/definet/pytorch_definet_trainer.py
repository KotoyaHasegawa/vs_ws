...
class Trainer:
    ...
    def train_step(self):
        for epoch in range(self.epochs):
            ...
            # evalute by validation 
                ...
                val_acc_sum,loss_validation= self.test(self.network, self.x_test, self.t_test, 5, self.device)
            ...
            if (epoch + 1) % 100 ==0 :
                # パラメータの保存
                torch.save(self.network.state_dict(), 'definet_params_epoch{}.pt'.format(epoch + 1))
    ...
    def test(self, net, x, t, mini_batch_size, device):
        ...
        return  acc_sum, loss_validation
